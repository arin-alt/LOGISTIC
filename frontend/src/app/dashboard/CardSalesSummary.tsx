...
const CardSalesSummary: React.FC = () => {
  ...
  // Calculate total sales value across all data
  ...
  const highestValueData = salesData.reduce(
    (acc, curr) =>
      acc?.totalValue && curr?.totalValue && acc.totalValue > curr.totalValue
        ? acc
        : curr,
    salesData[0]
  );
          ...
          <div>
            ...
            <div className="flex justify-between items-center mb-6 px-7 mt-5">
              <div className="text-lg font-medium">
                <p className="text-xs text-gray-400">Total Sales Value</p>
