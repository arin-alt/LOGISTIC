...
import Header from "@/components/Header"; // Adjusted path for the Header component
import Rating from "@components/Rating/Rating"; // Adjusted path for the Rating component
